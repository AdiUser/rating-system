                                              ...
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                  ...
                                                  <select name="faculty-level" id="" class="form-control">
                                                    ...
                                                    <option value="9A">Assistant Professor - 10</option>
                                                    <option value="10">Assistant Professor -11</option>
                                                    <option value="11">Assistant Professor - 12</option>
                                                    <option value="13A1">Associate Professor - 13A1</option>
													<option value="13A1">Professor - 14</option>
                                                  </select>
                                                </div>
                                              </div>
                                            </div>
