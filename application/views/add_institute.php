     ...
     <?php require_once('side-bar.php')?>
      <main class="main">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="add_Institute">Add Institute</a>
          </li>
          <!-- Breadcrumb Menu-->
        </ol>
          ...
          <div class="animated fadeIn">
            <div class="row">
                                          ...
                                          <div class="row">
                                              <div class="col-md-7">
                                                <div class="form-group" method="post">
                                                  ...
                                                  <input class="form-control" name="uname" id="company" type="text" placeholder="Enter Institute name">
                                                </div>
                                              </div>
                                              <div class="col-md-5">
                                                <div class="form-group" method="post">
                ...
                <div class="col-md-4">
                  <div class="card">
                    <div class="card-header">
                      <strong>Recently Added Institutes</strong>
                    </div>
                    <div class="card-body">
